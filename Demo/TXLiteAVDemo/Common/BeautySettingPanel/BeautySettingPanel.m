...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    if(collectionView == _effectCollectionView){
        ...
        TextCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:[TextCell reuseIdentifier] forIndexPath:indexPath];
        cell.label.text = self.motionArray[indexPath.row];
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(collectionView == _functionCollectionView){
        ...
        text = self.motionArray[indexPath.row];
    }
...
- (NSMutableArray*)motionArray
{
    if (!_motionArray) {
        ...
        [_motionArray addObject:@"动效1"];
        [_motionArray addObject:@"动效2"];
    }
...
- (UISlider *)beautySlider
{
    if(!_beautySlider){
        ...
        [_beautySlider setMinimumTrackTintColor:[UIColor redColor]];
...
- (UILabel *)beautyLabel
{
    if(!_beautyLabel){
        ...
        _beautyLabel.text = @"0";
        [_beautyLabel setTextColor:[UIColor redColor]];
    }
    return _beautyLabel;
}
...
- (UISlider *)filterSlider
{
    if(!_filterSlider){
        ...
        [_filterSlider setMinimumTrackTintColor:[UIColor redColor]];
...
- (UILabel *)filterLabel
{
    if(!_filterLabel){
        ...
        _filterLabel.text = @"0";
        [_filterLabel setTextColor:[UIColor redColor]];
    }
    return _filterLabel;
}
